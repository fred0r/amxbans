...
//ban delete
if(isset($_POST["del_ban_x"]) && isset($_POST["bid"]) && $_SESSION["loggedin"] && ($_SESSION['bans_delete']=="yes" || ($_SESSION['bans_delete']=="own" && isset($ban_detail['username']) && $_SESSION['uname']==$ban_detail['username']))) {
