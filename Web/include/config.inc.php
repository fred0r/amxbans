...
if(!isset($_SESSION["lang"]) || !$_SESSION["lang"]) $_SESSION["lang"]=$config->default_lang;
...
class dynamicPage extends Smarty {
	function __construct() {
		...
		$this->assign("csrf_token", isset($_SESSION['csrf_token']) ? $_SESSION['csrf_token'] : '');
	}
}