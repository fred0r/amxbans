				...
				{foreach from=$servers item=server}
					<form method="post">
						...
						{if $server.mod}
							<tr> 
								<td><form method="post">
								<input type="hidden" name="csrf_token" value="{$csrf_token}"><input type="hidden" name="server" value="{$server.id}"/><input class="button" type="submit" value="{"_VIEWSETTINGS"|lang}"/></form></td>
						...
						{else}
							<tr class="offline"> 
								<td><form method="post">
								<input type="hidden" name="csrf_token" value="{$csrf_token}"><input type="hidden" name="server" value="0"/><input class="button" type="submit" value="{"_VIEWSETTINGS"|lang}" disabled="disabled"/></form></td>
