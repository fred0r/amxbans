		...
		{if $smarty.session.permissions_edit == "yes"}
			...
			<table width="60%" align="center"><tr><td>
				...
				<table style="border:1px;" width="100%">
					...
					<tr>
						<td rowspan="4" style="{if $level.level==$smarty.session.level}background-color:#00aa00;{/if}text-align:center;"><b>{$level.level}</b></td>
						<td>{html_options name=bans_add values=$choose1 output=$output1|lang selected=$level.bans_add}</td>
						<td>{html_options name=bans_edit values=$choose2 output=$output2|lang selected=$level.bans_edit}</td>
						<td>{html_options name=bans_delete values=$choose2 output=$output2|lang selected=$level.bans_delete}</td>
						<td>{html_options name=bans_unban values=$choose2 output=$output2|lang selected=$level.bans_unban}</td>
						<td>{html_options name=bans_import values=$choose1 output=$output1|lang selected=$level.bans_import}</td>
						<td>{html_options name=bans_export values=$choose1 output=$output1|lang selected=$level.bans_export}</td>
						<td>{html_options name=amxadmins_view values=$choose1 output=$output1|lang selected=$level.amxadmins_view}</td>
						<td>{html_options name=amxadmins_edit values=$choose1 output=$output1|lang selected=$level.amxadmins_edit}</td>
						...
						<td>{html_options name=webadmins_view values=$choose1 output=$output1|lang selected=$level.webadmins_view}</td>
						<td>{html_options name=webadmins_edit values=$choose1 output=$output1|lang selected=$level.webadmins_edit}</td>
						<td>{html_options name=websettings_view values=$choose1 output=$output1|lang selected=$level.websettings_view}</td>
						<td>{html_options name=websettings_edit values=$choose1 output=$output1|lang selected=$level.websettings_edit}</td>
						
						<td>{html_options name=permissions_edit values=$choose1 output=$output1|lang selected=$level.permissions_edit}</td>
						<td>{html_options name=prune_db values=$choose1 output=$output1|lang selected=$level.prune_db}</td>
						<td>{html_options name=servers_edit values=$choose1 output=$output1|lang selected=$level.servers_edit}</td>
						<td>{html_options name=ip_view values=$choose1 output=$output1|lang selected=$level.ip_view}</td>
					</tr>
				</table></fieldset>
